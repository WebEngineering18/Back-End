    ...
    var app = new Vue({
        ...
        data: {
            ...
            answers: [
                ...
                { question_id: 7, answer: [], type: "singlePercentage" }, //number
                ...
                { question_id: 12, answer: [], type: "singlePercentage" }, //checkbox
                { question_id: 13, answer: [], other: "", type: "checkbox" }, //checkbox with other text
                { question_id: 14, answer: ["0", "0", "0"], type: "100%" }, //3 numbers
                { question_id: 15, answer: [], type: "year-choose" }, //all years and every year
                { question_id: 16, answer: [], type: "year-choose" }, //all years and every year
                { question_id: 17, answer: [], type: "number" }, //number
                { question_id: 18, answer: [], type: "year-choose" }, //all years and every year
        ...
        methods: {
            ...
            validate: function () {
                ...
                } else if (this.answers[this.questionIndex - 1].type == "2013-2017" || this.answers[this.questionIndex - 1].type == "year-choose") {
                    if (this.answers[this.questionIndex - 1].answer <= 0) {
                ...
                } else if (this.answers[this.questionIndex - 1].type == "everyYear") {

                    if (this.answers[this.questionIndex - 1].answer.length != 5) {
                        this.errorMessage = "Sie müssen für jedes Jahr eine Zahl eintragen!"
                        this.error = true;
                    } else {
                        this.error = false;
                    }
                ...
                else if (this.answers[this.questionIndex - 1].type == "singlePercentage") {
